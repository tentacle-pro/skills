...
# With aspect ratio
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "A landscape" --image out.png --ar 16:9

# High quality
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "A cat" --image out.png --quality 2k
...
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "Make blue" --image out.png --ref source.png

# With reference images (explicit provider/model)
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "Make blue" --image out.png --provider google --model gemini-3-pro-image-preview --ref source.png

# Specific provider
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "A cat" --image out.png --provider openai

# DashScope (阿里通义万象)
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "一只可爱的猫" --image out.png --provider dashscope

# Replicate (google/nano-banana-pro)
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "A cat" --image out.png --provider replicate

# Replicate with specific model
bun .agents/skills/baoyu-image-gen/scripts/main.ts --prompt "A cat" --image out.png --provider replicate --model google/nano-banana
```
...
1. CLI flag: `--model <id>`
2. Env var: `<PROVIDER>_IMAGE_MODEL` (e.g., `GOOGLE_IMAGE_MODEL`)
3. Built-in default

**Agent MUST display model info** before each generation:
- Show: `Using [provider] / [model]`
- Show switch hint: `Switch model: --model <id> | env <PROVIDER>_IMAGE_MODEL`
