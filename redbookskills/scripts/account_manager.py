...
Usage:
    uv run .agents/skills/redbookskills/scripts/account_manager.py list
    uv run .agents/skills/redbookskills/scripts/account_manager.py add <name> [--alias <alias>]
    uv run .agents/skills/redbookskills/scripts/account_manager.py remove <name>
    uv run .agents/skills/redbookskills/scripts/account_manager.py info <name>
    uv run .agents/skills/redbookskills/scripts/account_manager.py set-default <name>
"""
...
PROFILES_BASE = os.path.join(RUNTIME_DIR, "chrome-profiles")
