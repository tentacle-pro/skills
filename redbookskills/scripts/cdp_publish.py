...
CLI usage:
    # Basic commands
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] check-login [--headless] [--account NAME] [--reuse-existing-tab]
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] fill --title "标题" --content "正文" --images img1.jpg [--headless] [--account NAME] [--reuse-existing-tab]
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] publish --title "标题" --content "正文" --images img1.jpg [--headless] [--account NAME] [--reuse-existing-tab]
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] click-publish [--headless] [--account NAME] [--reuse-existing-tab]
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] search-feeds --keyword "关键词" [--sort-by 综合|最新|最多点赞|最多评论|最多收藏]
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] get-feed-detail --feed-id FEED_ID --xsec-token TOKEN
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] post-comment-to-feed --feed-id FEED_ID --xsec-token TOKEN --content "评论内容"
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] get-notification-mentions [--wait-seconds 18]
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] content-data [--page-num 1] [--page-size 10] [--type 0]

    # Account management
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] login [--account NAME]           # open browser for QR login
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] re-login [--account NAME]        # clear cookies and re-login same account
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] switch-account [--account NAME]  # clear cookies + open login for new account
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] list-accounts                    # list all configured accounts
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] add-account NAME [--alias ALIAS] # add a new account
    uv run .agents/skills/redbookskills/scripts/cdp_publish.py [--host HOST] [--port PORT] remove-account NAME              # remove an account
...
# "uv run .agents/skills/redbookskills/scripts/cdp_publish.py" and "import scripts.cdp_publish" modes.
...
def main():
    ...
    if args.command == "list-accounts":
        ...
        if add_account(args.name, args.alias):
            ...
            print(
                "  uv run .agents/skills/redbookskills/scripts/cdp_publish.py "
                f"--account {args.name} login"
            )
        else:
